...
describe('CaixaDaLanchonete', () => {
    ...
    test.each([
        ['combo e café', 'dinheiro', 'R$ 11,88', ['combo1,1', 'cafe,1']],
        ['múltiplos chantilys', 'debito', 'Item extra não pode ser pedido sem o principal', ['chantily,3']],
        ['múltiplos queijos', 'credito', 'Item extra não pode ser pedido sem o principal', ['queijo,2']],
        ['chantily e queijo', 'debito', 'Item extra não pode ser pedido sem o principal', ['cafe,1', 'chantily,1', 'queijo,1']],
        ['queijo e salgado', 'credito', 'Item extra não pode ser pedido sem o principal', ['salgado,1', 'queijo,1']],
        ['combo com extra', 'dinheiro', 'Item extra não pode ser pedido sem o principal', ['combo1,1', 'queijo,1']],
        ['compra mista', 'debito', 'R$ 27,90', ['cafe,3', 'suco,2', 'sanduiche,1']]
    ])('compra %p em %p deve resultar em %p', (_, formaDePagamento, resultadoEsperado, itens) =>
        validaTeste(formaDePagamento, resultadoEsperado, itens));
